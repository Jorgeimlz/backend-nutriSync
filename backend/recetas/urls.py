...
from .views import (
    ...
    agregar_ingrediente_a_receta  # Si decides implementar esta vista
)
...
urlpatterns = [
    ...
    path('<int:receta_id>/ingredientes/', agregar_ingrediente_a_receta, name='agregar_ingrediente_a_receta'),  # Ruta opcional
]
